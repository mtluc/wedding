...
class CheckBox extends BaseControl<
  ICheckBoxProps,
  IControlState<ICheckBoxProps>
> {
  static contextType = FormContext;

  public override type: ControlType = "check";

  override initState(props: ICheckBoxProps) {
  ...
  static getDerivedStateFromProps(
    ...
    prevState: IControlState<ICheckBoxProps>
  ) {
    const newState: any = {};
  ...
  render() {
    return (
      <input
        ...
        className={buildClass(["mtl-checkbox", this.props.className])}
